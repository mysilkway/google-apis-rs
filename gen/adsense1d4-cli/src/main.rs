                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["use-timezone-reporting", "locale", "max-results", "start-index", "metric", "sort", "filter", "currency", "dimension"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["use-timezone-reporting", "locale", "account-id", "max-results", "start-index", "metric", "sort", "filter", "currency", "dimension"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
