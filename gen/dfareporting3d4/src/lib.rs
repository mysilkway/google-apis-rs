...
//! * [reports](api::Report)
//!  * [*compatible fields query*](api::ReportCompatibleFieldQueryCall), [*delete*](api::ReportDeleteCall), [*files get*](api::ReportFileGetCall), [*files list*](api::ReportFileListCall), [*get*](api::ReportGetCall), [*insert*](api::ReportInsertCall), [*list*](api::ReportListCall), [*run*](api::ReportRunCall) and [*update*](api::ReportUpdateCall)
//! * [sites](api::Site)
