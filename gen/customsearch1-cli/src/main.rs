                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["cx", "img-type", "c2coff", "rights", "or-terms", "lr", "safe", "img-size", "related-site", "link-site", "hq", "file-type", "exact-terms", "site-search", "low-range", "hl", "img-color-type", "gl", "filter", "search-type", "site-search-filter", "exclude-terms", "q", "start", "img-dominant-color", "high-range", "date-restrict", "googlehost", "sort", "num", "cr"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
