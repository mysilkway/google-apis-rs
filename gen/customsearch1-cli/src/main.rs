...
extern crate mime;
extern crate strsim;
extern crate google_customsearch1;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::Customsearch<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>>>,
    gp: Vec<&'static str>,
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["or-terms", "exclude-terms", "site-search", "lr", "gl", "link-site", "img-color-type", "low-range", "sort", "site-search-filter", "img-dominant-color", "img-size", "hl", "filter", "file-type", "date-restrict", "c2coff", "cx", "exact-terms", "safe", "num", "related-site", "high-range", "googlehost", "search-type", "rights", "hq", "cr", "q", "start", "img-type"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
