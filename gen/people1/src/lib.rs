...
//! * other contacts
//!  * [*copy other contact to my contacts group*](api::OtherContactCopyOtherContactToMyContactsGroupCall) and [*list*](api::OtherContactListCall)
//! * people
//!  * [*connections list*](api::PeopleConnectionListCall), [*create contact*](api::PeopleCreateContactCall), [*delete contact*](api::PeopleDeleteContactCall), [*delete contact photo*](api::PeopleDeleteContactPhotoCall), [*get*](api::PeopleGetCall), [*get batch get*](api::PeopleGetBatchGetCall), [*list directory people*](api::PeopleListDirectoryPeopleCall), [*search directory people*](api::PeopleSearchDirectoryPeopleCall), [*update contact*](api::PeopleUpdateContactCall) and [*update contact photo*](api::PeopleUpdateContactPhotoCall)
//! 
//! 
//! 
//! 
