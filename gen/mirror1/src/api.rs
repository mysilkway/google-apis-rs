...
impl<'a, C> TimelineAttachmentInsertCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    pub fn upload_resumable<RS>(self, resumeable_stream: RS, mime_type: mime::Mime) -> client::Result<(hyper::Response<hyper::body::Body>, Attachment)>
                where RS: client::ReadSeek {
    ...
    /// * *max size*: 10MB
    /// * *valid mime types*: 'audio/*', 'image/*' and 'video/*'
    pub fn upload<RS>(self, stream: RS, mime_type: mime::Mime) -> client::Result<(hyper::Response<hyper::body::Body>, Attachment)>
                where RS: client::ReadSeek {
...
impl<'a, C> TimelineInsertCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    /// * *max size*: 10MB
    /// * *valid mime types*: 'audio/*', 'image/*' and 'video/*'
    pub fn upload_resumable<RS>(self, resumeable_stream: RS, mime_type: mime::Mime) -> client::Result<(hyper::Response<hyper::body::Body>, TimelineItem)>
                where RS: client::ReadSeek {
        self.doit(resumeable_stream, mime_type, "resumable")
    }
    /// Upload media all at once.
    ...
    /// * *max size*: 10MB
    /// * *valid mime types*: 'audio/*', 'image/*' and 'video/*'
    pub fn upload<RS>(self, stream: RS, mime_type: mime::Mime) -> client::Result<(hyper::Response<hyper::body::Body>, TimelineItem)>
                where RS: client::ReadSeek {
        self.doit(stream, mime_type, "simple")
    }
