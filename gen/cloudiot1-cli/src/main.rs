                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["device-ids", "page-token", "device-num-ids", "page-size", "gateway-list-options-associations-device-id", "gateway-list-options-gateway-type", "field-mask", "gateway-list-options-associations-gateway-id"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
