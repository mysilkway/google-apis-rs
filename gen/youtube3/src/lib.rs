...
//! * [guide categories](api::GuideCategory)
//!  * [*list*](api::GuideCategoryListCall)
...
//!  * [*bind*](api::LiveBroadcastBindCall), [*control*](api::LiveBroadcastControlCall), [*delete*](api::LiveBroadcastDeleteCall), [*insert*](api::LiveBroadcastInsertCall), [*list*](api::LiveBroadcastListCall), [*transition*](api::LiveBroadcastTransitionCall) and [*update*](api::LiveBroadcastUpdateCall)
...
//! * [sponsors](api::Sponsor)
//!  * [*list*](api::SponsorListCall)
...
//! * youtube
//!  * [*v3 infocards*](api::YoutubeV3InfocardCall), [*v3 infocards list*](api::YoutubeV3InfocardListCall) and [*v3 tests create*](api::YoutubeV3TestCreateCall)
//! 
//! 
//! Upload supported by ...
//! 
