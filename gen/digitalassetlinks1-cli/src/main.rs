...
extern crate mime;
extern crate strsim;
extern crate google_digitalassetlinks1;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::Digitalassetlinks<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>>>,
    gp: Vec<&'static str>,
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["source-android-app-certificate-sha256-fingerprint", "target-android-app-certificate-sha256-fingerprint", "relation", "target-web-site", "source-web-site", "source-android-app-package-name", "target-android-app-package-name"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["relation", "source-android-app-certificate-sha256-fingerprint", "source-web-site", "source-android-app-package-name"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
