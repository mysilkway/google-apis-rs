                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["source-android-app-package-name", "target-web-site", "target-android-app-package-name", "relation", "source-android-app-certificate-sha256-fingerprint", "source-web-site", "target-android-app-certificate-sha256-fingerprint"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["source-android-app-package-name", "relation", "source-android-app-certificate-sha256-fingerprint", "source-web-site"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
