...
//! 
//! * projects
//!  * [*operations get*](api::ProjectOperationGetCall), [*sites channels releases create*](api::ProjectSiteChannelReleaseCreateCall), [*sites channels releases list*](api::ProjectSiteChannelReleaseListCall), [*sites domains create*](api::ProjectSiteDomainCreateCall), [*sites domains delete*](api::ProjectSiteDomainDeleteCall), [*sites domains get*](api::ProjectSiteDomainGetCall), [*sites domains list*](api::ProjectSiteDomainListCall), [*sites domains update*](api::ProjectSiteDomainUpdateCall), [*sites get config*](api::ProjectSiteGetConfigCall), [*sites releases create*](api::ProjectSiteReleaseCreateCall), [*sites releases list*](api::ProjectSiteReleaseListCall), [*sites update config*](api::ProjectSiteUpdateConfigCall), [*sites versions create*](api::ProjectSiteVersionCreateCall), [*sites versions delete*](api::ProjectSiteVersionDeleteCall), [*sites versions files list*](api::ProjectSiteVersionFileListCall), [*sites versions list*](api::ProjectSiteVersionListCall), [*sites versions patch*](api::ProjectSiteVersionPatchCall) and [*sites versions populate files*](api::ProjectSiteVersionPopulateFileCall)
//! * sites
//!  * [*channels releases create*](api::SiteChannelReleaseCreateCall), [*channels releases list*](api::SiteChannelReleaseListCall), [*domains create*](api::SiteDomainCreateCall), [*domains delete*](api::SiteDomainDeleteCall), [*domains get*](api::SiteDomainGetCall), [*domains list*](api::SiteDomainListCall), [*domains update*](api::SiteDomainUpdateCall), [*get config*](api::SiteGetConfigCall), [*releases create*](api::SiteReleaseCreateCall), [*releases list*](api::SiteReleaseListCall), [*update config*](api::SiteUpdateConfigCall), [*versions create*](api::SiteVersionCreateCall), [*versions delete*](api::SiteVersionDeleteCall), [*versions files list*](api::SiteVersionFileListCall), [*versions list*](api::SiteVersionListCall), [*versions patch*](api::SiteVersionPatchCall) and [*versions populate files*](api::SiteVersionPopulateFileCall)
//! 
//! 
//! 
//! 
