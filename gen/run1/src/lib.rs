...
//! 
//! * api
//!  * [*v1 namespaces get*](api::ApiV1NamespaceGetCall), [*v1 namespaces patch*](api::ApiV1NamespacePatchCall), [*v1 namespaces secrets create*](api::ApiV1NamespaceSecretCreateCall), [*v1 namespaces secrets get*](api::ApiV1NamespaceSecretGetCall) and [*v1 namespaces secrets replace secret*](api::ApiV1NamespaceSecretReplaceSecretCall)
...
//! * projects
//!  * [*locations authorizeddomains list*](api::ProjectLocationAuthorizeddomainListCall), [*locations configurations get*](api::ProjectLocationConfigurationGetCall), [*locations configurations list*](api::ProjectLocationConfigurationListCall), [*locations domainmappings create*](api::ProjectLocationDomainmappingCreateCall), [*locations domainmappings delete*](api::ProjectLocationDomainmappingDeleteCall), [*locations domainmappings get*](api::ProjectLocationDomainmappingGetCall), [*locations domainmappings list*](api::ProjectLocationDomainmappingListCall), [*locations list*](api::ProjectLocationListCall), [*locations namespaces get*](api::ProjectLocationNamespaceGetCall), [*locations namespaces patch*](api::ProjectLocationNamespacePatchCall), [*locations revisions delete*](api::ProjectLocationRevisionDeleteCall), [*locations revisions get*](api::ProjectLocationRevisionGetCall), [*locations revisions list*](api::ProjectLocationRevisionListCall), [*locations routes get*](api::ProjectLocationRouteGetCall), [*locations routes list*](api::ProjectLocationRouteListCall), [*locations secrets create*](api::ProjectLocationSecretCreateCall), [*locations secrets get*](api::ProjectLocationSecretGetCall), [*locations secrets replace secret*](api::ProjectLocationSecretReplaceSecretCall), [*locations services create*](api::ProjectLocationServiceCreateCall), [*locations services delete*](api::ProjectLocationServiceDeleteCall), [*locations services get*](api::ProjectLocationServiceGetCall), [*locations services get iam policy*](api::ProjectLocationServiceGetIamPolicyCall), [*locations services list*](api::ProjectLocationServiceListCall), [*locations services replace service*](api::ProjectLocationServiceReplaceServiceCall), [*locations services set iam policy*](api::ProjectLocationServiceSetIamPolicyCall) and [*locations services test iam permissions*](api::ProjectLocationServiceTestIamPermissionCall)
//! 
//! 
//! 
//! 
...
//!              .watch(true)
//!              .resource_version("gubergren")
//!              .limit(-51)
//!              .label_selector("gubergren")
//!              .include_uninitialized(false)
//!              .field_selector("dolor")
//!              .continue_("ea")
//!              .doit();
//! 
//! match result {
