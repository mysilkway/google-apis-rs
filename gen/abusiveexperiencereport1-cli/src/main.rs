...
extern crate mime;
extern crate strsim;
extern crate google_abusiveexperiencereport1;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::AbusiveExperienceReport<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>>>,
    gp: Vec<&'static str>,
