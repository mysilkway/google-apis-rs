...
//! 
//! * bidders
//!  * [*creatives list*](api::BidderCreativeListCall) and [*creatives watch*](api::BidderCreativeWatchCall)
//! * buyers
//!  * [*creatives create*](api::BuyerCreativeCreateCall), [*creatives get*](api::BuyerCreativeGetCall), [*creatives list*](api::BuyerCreativeListCall), [*creatives patch*](api::BuyerCreativePatchCall), [*get remarketing tag*](api::BuyerGetRemarketingTagCall), [*user lists close*](api::BuyerUserListCloseCall), [*user lists create*](api::BuyerUserListCreateCall), [*user lists get*](api::BuyerUserListGetCall), [*user lists get remarketing tag*](api::BuyerUserListGetRemarketingTagCall), [*user lists list*](api::BuyerUserListListCall), [*user lists open*](api::BuyerUserListOpenCall) and [*user lists update*](api::BuyerUserListUpdateCall)
//! 
//! 
//! 
//! 
