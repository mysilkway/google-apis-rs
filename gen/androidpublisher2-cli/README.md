...
androidpublisher2 [options]
        edits
                ...
                apks-upload <package-name> <edit-id> (-u (resumable|simple) -f <file> [-m <mime>]) [-p <v>]... [-o <out>]
                bundles-list <package-name> <edit-id> [-p <v>]... [-o <out>]
                bundles-upload <package-name> <edit-id> (-u (resumable|simple) -f <file> [-m <mime>]) [-p <v>]... [-o <out>]
                commit <package-name> <edit-id> [-p <v>]... [-o <out>]
                delete <package-name> <edit-id> [-p <v>]...
                deobfuscationfiles-upload <package-name> <edit-id> <apk-version-code> <deobfuscation-file-type> (-u (resumable|simple) -f <file> [-m <mime>]) [-p <v>]... [-o <out>]
                ...
                expansionfiles-upload <package-name> <edit-id> <apk-version-code> <expansion-file-type> (-u (resumable|simple) -f <file> [-m <mime>]) [-p <v>]... [-o <out>]
                ...
                images-upload <package-name> <edit-id> <language> <image-type> (-u (resumable|simple) -f <file> [-m <mime>]) [-p <v>]... [-o <out>]
