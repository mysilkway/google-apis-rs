...
///              .add_mask_field_paths("amet.")
///              .document_id("takimata")
///              .doit();
/// # }
/// ```
...
///              .current_document_update_time("duo")
...
///              .add_update_mask_field_paths("ipsum")
///              .add_mask_field_paths("ipsum")
///              .current_document_update_time("est")
///              .current_document_exists(true)
///              .doit();
/// # }
/// ```
