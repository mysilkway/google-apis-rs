...
///              .page_size(-2)
///              .order_by("sed")
///              .interval_start_time("takimata")
///              .interval_end_time("dolores")
///              .filter("gubergren")
///              .aggregation_per_series_aligner("et")
///              .add_aggregation_group_by_fields("accusam")
///              .aggregation_cross_series_reducer("voluptua.")
///              .aggregation_alignment_period("dolore")
///              .doit();
/// # }
/// ```
