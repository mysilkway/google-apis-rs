...
impl<'a, C> TransferJobMethods<'a, C> {
    ...
    pub fn get(&self, job_name: &str) -> TransferJobGetCall<'a, C> {
        TransferJobGetCall {
            hub: self.hub,
    ...
    ///
    /// Lists transfer jobs.
    pub fn list(&self) -> TransferJobListCall<'a, C> {
        TransferJobListCall {
            hub: self.hub,
...
impl<'a, C> TransferOperationMethods<'a, C> {
    ...
    pub fn cancel(&self, name: &str) -> TransferOperationCancelCall<'a, C> {
    ...
    pub fn list(&self, name: &str) -> TransferOperationListCall<'a, C> {
