...
impl<'a, C> client::Hub for Sasportal<C> {}

impl<'a, C> Sasportal<C>
    where  C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {

    pub fn new(client: C, authenticator: oauth2::authenticator::Authenticator<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>>) -> Sasportal<C> {
        Sasportal {
...
/// 
/// * [devices bulk customers](CustomerDeviceBulkCall) (request)
/// * [devices bulk nodes](NodeDeviceBulkCall) (request)
/// * [nodes devices bulk nodes](NodeNodeDeviceBulkCall) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::RequestValue for SasPortalBulkCreateDeviceRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [devices bulk customers](CustomerDeviceBulkCall) (response)
/// * [devices bulk nodes](NodeDeviceBulkCall) (response)
/// * [nodes devices bulk nodes](NodeNodeDeviceBulkCall) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl client::ResponseResult for SasPortalBulkCreateDeviceResponse {}
...
impl<'a, C> CustomerMethods<'a, C> {
    ...
    pub fn devices_bulk(&self, request: SasPortalBulkCreateDeviceRequest, parent: &str) -> CustomerDeviceBulkCall<'a, C> {
...
impl<'a, C> NodeMethods<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `parent` - Required. The name of the parent resource.
    pub fn devices_bulk(&self, request: SasPortalBulkCreateDeviceRequest, parent: &str) -> NodeDeviceBulkCall<'a, C> {
        NodeDeviceBulkCall {
            hub: self.hub,
            _request: request,
            _parent: parent.to_string(),
    ...
    /// * `request` - No description provided.
    /// * `parent` - Required. The name of the parent resource.
    pub fn nodes_devices_bulk(&self, request: SasPortalBulkCreateDeviceRequest, parent: &str) -> NodeNodeDeviceBulkCall<'a, C> {
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_sasportal1_alpha1 as sasportal1_alpha1;
/// use sasportal1_alpha1::api::SasPortalBulkCreateDeviceRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use sasportal1_alpha1::Sasportal;
...
/// # }
/// ```
pub struct CustomerDeviceBulkCall<'a, C>
    where C: 'a {
...
impl<'a, C> client::CallBuilder for CustomerDeviceBulkCall<'a, C> {}

impl<'a, C> CustomerDeviceBulkCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {


    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, SasPortalBulkCreateDeviceResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "sasportal.customers.devices.bulk",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
;
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SasPortalBulkCreateDeviceRequest) -> CustomerDeviceBulkCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerDeviceBulkCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> CustomerDeviceBulkCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerDeviceBulkCall<'a, C>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> CustomerDeviceBulkCall<'a, C>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct NodeDeviceBulkCall<'a, C>
    where C: 'a {
...
impl<'a, C> client::CallBuilder for NodeDeviceBulkCall<'a, C> {}

impl<'a, C> NodeDeviceBulkCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, SasPortalBulkCreateDeviceResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "sasportal.nodes.devices.bulk",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
;
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SasPortalBulkCreateDeviceRequest) -> NodeDeviceBulkCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The name of the parent resource.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> NodeDeviceBulkCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> NodeDeviceBulkCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> NodeDeviceBulkCall<'a, C>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> NodeDeviceBulkCall<'a, C>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct NodeNodeDeviceBulkCall<'a, C>
    where C: 'a {
...
impl<'a, C> client::CallBuilder for NodeNodeDeviceBulkCall<'a, C> {}

impl<'a, C> NodeNodeDeviceBulkCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, SasPortalBulkCreateDeviceResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "sasportal.nodes.nodes.devices.bulk",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
;
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SasPortalBulkCreateDeviceRequest) -> NodeNodeDeviceBulkCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The name of the parent resource.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> NodeNodeDeviceBulkCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> NodeNodeDeviceBulkCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> NodeNodeDeviceBulkCall<'a, C>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> NodeNodeDeviceBulkCall<'a, C>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
