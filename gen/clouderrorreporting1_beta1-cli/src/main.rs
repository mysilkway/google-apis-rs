                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["group-id", "page-token", "service-filter-version", "service-filter-service", "page-size", "service-filter-resource-type", "time-range-period"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["group-id", "page-token", "alignment-time", "order", "service-filter-version", "timed-count-duration", "service-filter-service", "alignment", "page-size", "service-filter-resource-type", "time-range-period"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
