                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["time-range-period", "page-size", "service-filter-service", "service-filter-resource-type", "service-filter-version", "group-id", "page-token"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["time-range-period", "timed-count-duration", "page-size", "service-filter-service", "service-filter-resource-type", "alignment-time", "alignment", "order", "service-filter-version", "group-id", "page-token"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
