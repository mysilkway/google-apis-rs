...
extern crate mime;
extern crate strsim;
extern crate google_driveactivity2;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::DriveActivityHub<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>>>,
    gp: Vec<&'static str>,
