...
extern crate mime;
extern crate strsim;
extern crate google_pagespeedonline5;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::PagespeedInsights<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>>>,
    gp: Vec<&'static str>,
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["category", "url", "utm-campaign", "utm-source", "strategy", "locale", "captcha-token"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
