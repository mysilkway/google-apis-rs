...
extern crate mime;
extern crate strsim;
extern crate google_appsactivity1;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::Appsactivity<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>>>,
    gp: Vec<&'static str>,
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           ...
                                                                           v.extend(["source", "drive-ancestor-id", "grouping-strategy", "page-token", "user-id", "drive-file-id", "page-size"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
