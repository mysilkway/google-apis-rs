...
impl<'a, C> JobInsertCall<'a, C> where C: BorrowMut<hyper::Client<hyper_rustls::HttpsConnector<hyper::client::connect::HttpConnector>, hyper::body::Body>> {
    ...
    /// * *max size*: 0kb
    /// * *valid mime types*: '*/*'
    pub fn upload_resumable<RS>(self, resumeable_stream: RS, mime_type: mime::Mime) -> client::Result<(hyper::Response<hyper::body::Body>, Job)>
                where RS: client::ReadSeek {
    ...
    /// * *max size*: 0kb
    /// * *valid mime types*: '*/*'
    pub fn upload<RS>(self, stream: RS, mime_type: mime::Mime) -> client::Result<(hyper::Response<hyper::body::Body>, Job)>
                where RS: client::ReadSeek {
...
///              .add_state_filter("kasd")
///              .projection("et")
///              .parent_job_id("sed")
///              .page_token("et")
///              .min_creation_time("et")
///              .max_results(25)
///              .max_creation_time("erat")
///              .all_users(false)
///              .doit();
/// # }
/// ```
