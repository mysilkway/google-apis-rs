...
//! * [jobs](api::Job)
//!  * [*cancel*](api::JobCancelCall), [*get*](api::JobGetCall), [*get query results*](api::JobGetQueryResultCall), [*insert*](api::JobInsertCall), [*list*](api::JobListCall) and [*query*](api::JobQueryCall)
//! * [models](api::Model)
