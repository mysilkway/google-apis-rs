...
extern crate mime;
extern crate strsim;
extern crate google_firestore1_beta1;
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["show-missing", "page-size", "page-token", "order-by", "mask-field-paths", "read-time", "transaction"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["current-document-exists", "current-document-update-time", "update-mask-field-paths", "mask-field-paths"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
